...
fn initialize(
    ...
    let _num_epochs_in_a_year = NUM_SECONDS_PER_YEAR / genesis_config.epoch_duration_secs;
    ...
    let rewards_rate_numerator = 0; // todo: feature flag this for Movement Labs
